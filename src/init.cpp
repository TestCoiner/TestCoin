    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("FooCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  charitycoin [options]                     " + "\n" +
                  "  charitycoin [options] <command> [params]  " + _("Send command to -server or charitycoin") + "\n" +
                  "  charitycoin [options] help                " + _("List commands") + "\n" +
                  "  charitycoin [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: charitycoin.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 44884 or testnet: 45884)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 44883)") + "\n" +
...
//    }
    ...
    // requested to kill charitycoin-qt during the last operation. If so, exit.
